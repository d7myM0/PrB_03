...
<body>
    ...
    <form class="p-5 m-5" action="/update/{{$serv->id}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT');
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">العنوان</label>
          <input type="text" class="form-control" placeholder="{{$serv->title}}" name="tit">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" placeholder="{{$serv->description}}" name="des">
        </div>
